...
- Stephanie Dutkiewicz provided the examples
- Oliver Jahn and collaborators the Darwin3 source code
- Gaël Forget the MITgcm.jl interface and notebook prototype

!!! note
	For more information, please refer to 
	- [darwin3.readthedocs](https://darwin3.readthedocs.io/en/latest/phys_pkgs/darwin.html)
	- [darwinpropject.mit.edu](https://darwinproject.mit.edu)
	- [cbiomes.org](https://darwinproject.mit.edu)
	- [MITgcm.readthedocs](http://mitgcm.readthedocs.io/en/latest/?badge=latest)
...
# ╔═╡ 898eb5f8-123b-43eb-9a6a-61d4ddec344d
begin
	MITgcm.set_environment_variables_to_default()
	if Sys.isapple()&&(Sys.ARCH==:aarch64) 
		opt="-mods=../code_31+16+3_RT_1D -optfile=../../../tools/build_options/darwin_arm64_gfortran"
	else
		opt="-mods=../code_31+16+3_RT_1D"
	end
...
begin
	...
	MC.inputs[:setup][:build][:options]=opt	
...
function ptr_name(ptr)
	s=ptr>99 ? "$(ptr)" : ( ptr>9 ? " $(ptr)" : "  $(ptr)" )
	s=Symbol("PTRACERS_names($(s))")
...
manifest_format = "2.0"
project_hash = "233c8e200649a519317794032d54d3c284926d0a"
