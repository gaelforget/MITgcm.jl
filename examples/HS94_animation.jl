...
begin
	...
	using MITgcm, DataDeps, MeshArrays, Plots, PlutoUI
...
# ╔═╡ 41dd1e9e-8d39-4f10-93e5-1c495a052281
myexp
...
begin
	lnk=joinpath(tempdir(),"HS94_animation_link")
	ispath(lnk) ? rm(lnk) : nothing
...
#	myexp.inputs[:setup][:build][:exe]=filexe
	...
	filexe=joinpath(myexp,"MITgcm","verification",config,"build","mitgcmuv")
...
begin
	step3==🏁
	stdout1=readlines(joinpath(pth_run,"output.txt"))
	Dump(stdout1)
end
...
manifest_format = "2.0"
project_hash = "c8507d7b06440a7f5d8f484be36abff8f8677aa8"
