...
function myviz(G; title="grid points")
    ...
    for f in 1:length(G.XC)
        ...
        MeshViz.viz!(ax,tmp,color=col[f],size=1.5)
    end
...
[[deps.MeshViz]]
deps = ["CategoricalArrays", "Colors", "Makie", "Meshes", "Tables"]
git-tree-sha1 = "a4211e23bef69933c9b712885f9f99b46ec6af71"
...
git-tree-sha1 = "3ebe650dfbeae403bde5110ceaa93df343647130"
