...
begin
	...
	custom∫(prob) = IndividualDisplacements.ensemble_solver(prob;solver=Tsit5(),reltol=1e-5,abstol=1e-5,safetycopy=false)
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "d7d888a5459b49c560221ebe91c79e1bcacdc73e"
